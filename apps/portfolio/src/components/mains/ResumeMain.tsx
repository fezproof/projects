import { Box, Grid, Heading, Text, useMediaQuery } from '@chakra-ui/react';
...
const ResumeMain: FC = () => {
  ...
  return (
    <Grid gap="1rem" height="100%">
      <BasicCard>
        ...
        <Grid templateColumns="1fr" gap="0.75rem">
          <Box>
            ...
            <Text>
              This involved full stack technical and niche web development,
              WebGL, Serverless AWS, Federated GraphQL, advanced DevOps, etc.
            </Text>
          </Box>
          <Box>
            <Heading as="h4" size="sm">
            ...
            <Text>
              A fast, error resistant patient onboarding app to help triage
          ...
          <Box>
            ...
            <Text>
              An internal, company wide GraphQL service that encouraged
              innovation and cross cutting concerns in all of Purple's internal
              apps.
            </Text>
          </Box>
          <Box>
            ...
            <Text>
              Pedro is a scheduling app that Purple now uses internally to
              manage consultant across different gigs.
            </Text>
            <Text>
          ...
          <Box>
            ...
            <Text>
              The web app had to be extremely lightweight and tolerant bad or
      ...
      <Grid
        templateColumns={[isPrint ? '1fr 1fr' : '1fr', '1fr 1fr']}
        gap="1rem"
      >
        <BasicCard>
